...
## UI/UX Improvements - Favorites Page Redesign (March 14, 2026)
- [x] تحويل صفحة الأسعار المفضلة من جدول إلى بطاقات (مثل الصفحة الرئيسية)
- [x] إضافة صور البيض وأسماء المنتجات في كل بطاقة
- [x] عرض الأسعار المفضلة تحت كل بطاقة منتج
- [x] اختبار التصميم الجديد على شاشات مختلفة
